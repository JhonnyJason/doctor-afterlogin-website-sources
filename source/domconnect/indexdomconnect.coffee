...
indexdomconnect.initialize = () ->
    ...
    global.approvalSvnSwitch = document.getElementById("approval-svn-switch")
    ...
    global.approvalPinInput = document.getElementById("approval-pin-input")
    global.approvalAuthcodeInput = document.getElementById("approval-authcode-input")
